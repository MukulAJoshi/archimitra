(ns org.archimitra.feat.app
  (:require [com.biffweb :as biff :refer [q]]
            [org.archimitra.ui :as ui]
            [rum.core :as rum]
            [xtdb.api :as xt]
...
(defn notify-clients [{:keys [org.archimitra/chat-clients]} tx]
...
(defn ws-handler [{:keys [org.archimitra/chat-clients] :as req}]
  {:status 101
